...
public class ResizablePanels : EditorWindow
{
    ...
    private float resizerHeight = 10f;
    ...
    private void OnEnable()
    {
        ...
        boxStyle.normal.textColor = new Color(0.2f, 0.2f, 0.2f);

        boxBgOdd = EditorGUIUtility.Load("builtin skins/lightskin/images/cnentrybackodd.png") as Texture2D;
        ...
        textAreaStyle.normal.textColor = new Color(0, 0, 0);
    ...
    {
        lowerPanel = new Rect(0, position.height * sizeRatio, position.width, position.height * sizeRatio);
